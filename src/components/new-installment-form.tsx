...
} from "@/server/actions/installment-actions";
...
export function NewInstallmentForm({
  ...
  const [state, formAction, pending] = useActionState<InstallmentFormState, FormData>(
    createInstallmentPlanAction,
    undefined,
  );
    ...
    >
      ...
      <Field label="Parcelas">
        <input
          ...
          defaultValue={12}
          required
          className="w-20 rounded border border-slate-300 px-2 py-1 dark:border-zinc-700 dark:bg-zinc-950"
        />
      </Field>
